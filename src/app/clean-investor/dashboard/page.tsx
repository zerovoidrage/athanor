...
export default function CleanInvestorDashboardPage() {
  ...
  useEffect(() => {
    ...
    const sections = 3; // Изменено с 4 на 3 (убрали museum)
            ...
            >
              ...
              >
                ...
                >
                    ...
                    <div className="h-full flex items-start justify-center pt-8">
                      <div className="flex w-full max-w-7xl mx-auto px-6">
                        <div className="w-1/5 flex-shrink-0">
                          ...
                          <p className="text-caption text-white-700 max-w-[200px]">
                            Athanor Clean Investor Card —<br />
                  ...
                  {/* FACE 2 - Transactions (было FACE 3) */}
                  <div
                    className="absolute inset-0"
                    style={{
                      backfaceVisibility: 'hidden',
