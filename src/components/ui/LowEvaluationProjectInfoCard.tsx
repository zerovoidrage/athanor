...
interface LowEvaluationProjectInfoCardProps {
  isVisible: boolean;
  projectData: { name: string; imageIndex: number } | null;
  onClose: () => void;
}

export default function LowEvaluationProjectInfoCard({ isVisible, projectData, onClose }: LowEvaluationProjectInfoCardProps) {
            ...
            <AnimatePresence mode="wait">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-0">
                  ...
                  <span className="text-small" style={{ color: '#FF9D9D' }}>AI Evaluation (32%)</span>
                </div>
              </div>
